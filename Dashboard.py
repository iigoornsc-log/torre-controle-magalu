...
pagina = st.sidebar.radio("Ir para:", ["🏠 Painel Operacional", "🧩 Matriz de Planejamento"])
st.sidebar.markdown("---")
...
if pagina == "🏠 Painel Operacional":
    ...
    df_filtrado_op = df_filtrado[
        (df_filtrado['É Ofensor?'].isin(status_ofensor)) & 
        (df_filtrado['Canal'].isin(canal_selecionado)) & 
